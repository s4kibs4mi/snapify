...
//		GroupBy(screenshot.FieldStatus).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
func (sq *ScreenshotQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(screenshot.Table, screenshot.Columns, sqlgraph.NewFieldSpec(screenshot.FieldID, field.TypeUUID))
	_spec.From = sq.sql
